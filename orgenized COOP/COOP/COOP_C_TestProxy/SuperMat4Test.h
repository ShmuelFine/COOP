...
//OVERIDE_FUNCTION_PTR(SuperMat4Test, findLoc, int row, int col);
struct findLoc_t_ __findLoc; 
struct findLoc_t_* findLoc;
//findLoc_t __findLoc;
//findLoc_t  * findLoc;
END_FUNCTIONS(SuperMat4Test);

FUNCTION_H(SuperMat4Test, SetStep, int step);
FUNCTION_H(SuperMat4Test, findLoc, int row, int col, int* loc);
