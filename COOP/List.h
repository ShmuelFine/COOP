...
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, equals, object* other, bool* out_equal);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, next);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, prev);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, get_ref, void** out_ptr);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, get_cref, const void** out_ptr);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, distance, object* other, ptrdiff_t* out_dist);
OVERRIDE_MEM_FUN_DECL(ListIterator, Iterator, advance, ptrdiff_t n);
...
MEM_FUN_DECL(List_##type_name, insert_before, ListIterator* pos, 
    c_type val, ListIterator** out_it);                        
    MEM_FUN_DECL(List_##type_name, insert_after, ListIterator* pos, 
        c_type val, ListIterator** out_it);                        
    MEM_FUN_DECL(List_##type_name, erase, ListIterator* pos, 
        c_type* out, ListIterator** out_next);                     
